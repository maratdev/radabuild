...
<div class="container">
    <div class="row">
        <?php
        if (isset($title) && isset($meta_d) && isset($meta_k) && isset($text) && isset($img) && isset($categories)) {
            /* Здесь пишем что можно заносить информацию в базу */
            $result = mysql_query ("UPDATE page SET title='$title', meta_d='$meta_d', meta_k='$meta_k', text='$text', img='$img',categories='$categories' WHERE id='$id'");
